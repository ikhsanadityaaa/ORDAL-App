...
const TRANSLATIONS = {
  ...
  'auth.google_soon':    { id: 'Login Google sedang tidak tersedia di layanan ORDAL. Coba lagi nanti atau masuk dengan email.', en: 'Google sign-in is unavailable on the ORDAL service. Try again later or sign in with email.' },
  ...
  'auth.err_pass_len':   { id: 'Password minimal 8 karakter.', en: 'Password must be at least 8 characters.' },
