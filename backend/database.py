...
CREATE UNIQUE INDEX IF NOT EXISTS idx_user_email_canonical
ON "User" ("emailCanonical") WHERE "emailCanonical" IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_app_abuse_events_subject
ON app_abuse_events(event_type, subject_hash, created_at DESC);
